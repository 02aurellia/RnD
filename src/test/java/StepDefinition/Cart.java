...
public class Cart extends env {
	...
	public void user_go_to_selected_menu_page() {
		...
		WebDriverWait wait = new WebDriverWait(driver, duration);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[contains(text(),'Men')]")));
	}
	...
	public void user_go_to_selected_category() {
		...
		Duration duration = Duration.ofSeconds(3);
		WebDriverWait wait = new WebDriverWait(driver, duration);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[@class='base']")));
	}

	@And("User click button add to Cart")
	public void user_click_button_add_to_cart() {
		driver.findElement(By.xpath("//li[1]//div[1]//div[1]//div[3]//div[1]//div[1]//form[1]//button[1]//span[1]"))
				.click();
	}
	...
	public void user_get_alert_success_add_to_cart() {
		...
		// driver.findElement(By.xpath("//div[@data-bind='html:
		// $parent.prepareMessageForHtml(message.text)']")).isDisplayed();
		driver.quit();
	}
	...
	public void user_choose_product() {
		...
		WebElement element = driver
				.findElement(By.xpath("//a[@class='product photo product-item-photo']//img[@alt='Pierce Gym Short']"));
	...
	public void user_click_button_edit_product() {
		driver.findElement(By.xpath("//li[@class='item product product-item odd last']//a[@title='Edit item']"))
				.click();
		Duration duration = Duration.ofSeconds(3);
		WebDriverWait wait = new WebDriverWait(driver, duration);
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//span[normalize-space()='Update Cart']")));
	}
	...
	public void user_get_alert_options_required_field() {
		driver.findElement(By.xpath("//div[@class='swatch-attribute size']//div[contains(@id,'super_attribute')]"))
				.isDisplayed();
		driver.quit();
	}
